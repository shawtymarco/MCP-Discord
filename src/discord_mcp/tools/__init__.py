...
from discord_mcp.tools import channels, members, messages, moderation, reactions, server_info
...
_MODULES = [server_info, members, channels, messages, reactions, moderation]
